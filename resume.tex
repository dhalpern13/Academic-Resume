...
\newcommand{\talk}[3]{\begin{samepage}\textbf{#1} \hfill #2 \\\textit{#3}\end{samepage}}
...
% \maketitle %% This is LaTeX's default title constructed from \title,\author,\date
    ...
    \cvsubsection{Harvard University}[Cambridge, MA][Ph.D. in Computer Science][Aug. 2020--Present]
    \begin{itemize}
